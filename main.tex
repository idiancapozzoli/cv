...
\begin{center}
    ...
    \vspace{0.2cm}
    \href{mailto:idian@ime.usp.br}{idian@ime.usp.br}
...
\noindent\textbf{University of São Paulo}, São Paulo, Brazil \hfill  \textit{Aug 2025 -- Present} \\
\textit{Master Program in Computer Science} \hfill \\
Master Program in the department of computer science, under the supervision of Prof. Dr. Yoshiko Wakabayashi. \\

\noindent\textbf{University of São Paulo}, São Paulo, Brazil \hfill  \textit{Apr 2021 -- Jul 2025} \\
...
\noindent\textbf{Master's Research Project}  \hfill  \textit{Aug 2025 -- Present} \\
Project entitled "Colorings in Graphs: Duality and Fractional Relaxations", supervised by Profa. Yoshiko Wakabayashi, and funded by CNPq from august 2025 up to july 2026 and funded by FAPESP (grant 2026/00744--0) from august 2026 up to now. \\

\noindent\textbf{Undergrad Research Project}  \hfill  \textit{Sep 2023 -- Jul 2025} \\
A scientific research under the supervision of Profa. Yoshiko Wakabayashi and funded by CNPq from 2023
up to july 2025. The project was centered on the study of various topics in combinatorics and graph theory and in the study of longest paths in graphs from a structural perspective. \\
...
\noindent\textbf{Teaching Assistant}  \hfill  \textit{Aug 2025 -- Dec 2025}\\
Teaching assistant for the course Algorithms and Data Structures I.
...
\noindent\textbf{2nd Brazilian Workshop on Combinatorics} \hfill \textit{15 -- 19 June 2026}\\
Academic event with a special focus on the areas of Extremal Combinatorics, Probabilistic Combinatorics, Graph Theory, Algorithms, and Combinatorial Optimization. Its main objective is to train undergraduate and graduate students to conduct research in combinatorics, to promote the field through high-level lectures, and to foster cooperation among students and Brazilian researchers in order to discuss methods and seek solutions to problems and conjectures in the area.  \\

\noindent\textbf{2nd Brazilian School of Combinatorics} \hfill \textit{10 -- 14 Mar 2025}\\
Academic event focused on the training of students and researchers in contemporary topics of Combinatorics. The program included minicourses, lectures, and open problem sessions, fostering interaction among undergraduate and graduate students as well as faculty members in the field. \\
